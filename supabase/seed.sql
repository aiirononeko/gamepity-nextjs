...
values
  ('00000000-0000-0000-0000-000000000000', '185f2f83-d63a-4c9b-b4a0-7e4a885799e2', 'authenticated', 'authenticated', 'streamer1@email.com', '$2a$10$6gPtvpqCAiwavx1EOnjIgOykKMgzRdiBuejUQGIRRjvUi/ZgMh.9C', '{"provider":"email","providers":["email"]}', '{"name": "ゲテモノピロ毛1", "is_streamer": true, "stripe_account_id": "acct_1PApECFv02qblxZP" }', timezone('utc'::text, now()), timezone('utc'::text, now())),
  ('00000000-0000-0000-0000-000000000000', '185f2f83-d63a-4c9b-b4a0-7e4a885799e2', 'authenticated', 'authenticated', 'streamer1@email.com', '$2a$10$6gPtvpqCAiwavx1EOnjIgOykKMgzRdiBuejUQGIRRjvUi/ZgMh.9C', '{"provider":"email","providers":["email"]}', '{"name": "ゲテモノピロ毛1", "is_streamer": true, "stripe_account_id": "acct_1PApECFv02qblxZP" }', timezone('utc'::text, now()), timezone('utc'::text, now())),
  ('00000000-0000-0000-0000-000000000000', '185f2f83-d63a-4c9b-b4a0-7e4a885799e2', 'authenticated', 'authenticated', 'streamer1@email.com', '$2a$10$6gPtvpqCAiwavx1EOnjIgOykKMgzRdiBuejUQGIRRjvUi/ZgMh.9C', '{"provider":"email","providers":["email"]}', '{"name": "ゲテモノピロ毛1", "is_streamer": true, "stripe_account_id": "acct_1PApECFv02qblxZP" }', timezone('utc'::text, now()), timezone('utc'::text, now())),
  ('00000000-0000-0000-0000-000000000000', '185f2f83-d63a-4c9b-b4a0-7e4a885799e2', 'authenticated', 'authenticated', 'streamer1@email.com', '$2a$10$6gPtvpqCAiwavx1EOnjIgOykKMgzRdiBuejUQGIRRjvUi/ZgMh.9C', '{"provider":"email","providers":["email"]}', '{"name": "ゲテモノピロ毛1", "is_streamer": true, "stripe_account_id": "acct_1PApECFv02qblxZP" }', timezone('utc'::text, now()), timezone('utc'::text, now())),
  ('00000000-0000-0000-0000-000000000000', '185f2f83-d63a-4c9b-b4a0-7e4a885799e2', 'authenticated', 'authenticated', 'streamer1@email.com', '$2a$10$6gPtvpqCAiwavx1EOnjIgOykKMgzRdiBuejUQGIRRjvUi/ZgMh.9C', '{"provider":"email","providers":["email"]}', '{"name": "ゲテモノピロ毛1", "is_streamer": true, "stripe_account_id": "acct_1PApECFv02qblxZP" }', timezone('utc'::text, now()), timezone('utc'::text, now())),
...
insert into public.plans
  (name, description, amount, stripe_product_id, stripe_price_id, stripe_payment_link_id, created_at, updated_at, streamer_id)
values
  ('一緒に遊べるプラン1', '一緒に遊べます一緒に遊べます一緒に遊べます一緒に遊べます一緒に遊べます', 3000, '12345', '12345', '12345', NOW(), NOW(), '185f2f83-d63a-4c9b-b4a0-7e4a885799e2'),
  ('一緒に遊べるプラン2', '一緒に遊べます一緒に遊べます一緒に遊べます一緒に遊べます一緒に遊べます', 2000, '12341', '12341', '12341', NOW(), NOW(), '185f2f83-d63a-4c9b-b4a0-7e4a885799e2'),
  ('一緒に遊べるプラン3', '一緒に遊べます一緒に遊べます一緒に遊べます一緒に遊べます一緒に遊べます', 5000, '12342', '12342', '12342', NOW(), NOW(), '185f2f83-d63a-4c9b-b4a0-7e4a885799e2'),
  ('一緒に遊べるプラン4', '一緒に遊べます一緒に遊べます一緒に遊べます一緒に遊べます一緒に遊べます', 3000, '12343', '12343', '12343', NOW(), NOW(), '185f2f83-d63a-4c9b-b4a0-7e4a885799e3'),
  ('一緒に遊べるプラン5', '一緒に遊べます一緒に遊べます一緒に遊べます一緒に遊べます一緒に遊べます', 2000, '12344', '12344', '12344', NOW(), NOW(), '185f2f83-d63a-4c9b-b4a0-7e4a885799e3');
...
BEGIN
  ...
  FOR i IN 0..23 LOOP
    INSERT INTO public.available_date_times (start_date_time, created_at, updated_at, streamer_id)
    VALUES (start_ts + INTERVAL '1 hour' * i, NOW(), NOW(), '185f2f83-d63a-4c9b-b4a0-7e4a885799e2');
  END LOOP;
END $$;
